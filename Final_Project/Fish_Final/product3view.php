...
<body>
    ...
    <ul class="checkout">
        <a>
            <li class="image1">
                <img style="width: 130%;" src="Picture3.png" alt="">
            </li>
        </a>
        ...
        <a>
            <li class="text1" >
                <h1 style="width: 400px; font-family:serif; font-weight: lighter; font-size: 20px;" >
                    ...
                    <br>
                    <br>Description
                    Ensure your finned friend receives the nutrition he needs to thrive by serving this Omega One Natural Seafood Formula Frozen Super Carnivore Fish Food, which features frozen cubes that are made with Mysis Shrimp, Brine Shrimp and Bloodworms for a nourishing meal. The food is specially formulated for marine and freshwater carnivores, including Discus, Stingrays, Angel Fish, Puffers, Cichlids, Rainbow Fish and Blennies.
                    </h1>
            </li>
        </a>
                ...
                <h3>FREE DELIVERY: Tuesday,Dec 12
                    ...
                    <option selected="selected">Choose one</option>
                      <?php
                        ...
                        $conn = new mysqli($hn,$un,$pw,$db);
                        if($conn -> connect_error) die($conn -> connect_error);
                        $query = "SELECT Available FROM Inventory WHERE ProductID = 3";
                        $result = $conn -> query($query);
                        if(!$result) die(mysqli_error($conn));
                        $numRows = $result -> num_rows;
                        $row = $result -> fetch_array(MYSQLI_ASSOC);
                    ...
                    <br>
                    <input name='productId' value="3" hidden>
