...
<body>
    ...
    <ul class="shell">
        <li class="button">
            ...
            <ul>
                ...
                <li ><a href="Fishfood/fishfood.php">Fish food</a></li>
            </ul>
        </li>
    ...
    <ul class="checkout">
        <a>
            <li class="image1">
                <img style="width: 130%;" src="Picture2.png" alt="">
            </li>
        </a>
        ...
        <a>
            <li class="text1" >
                <h1 style="width: 400px; font-family:serif; font-weight: lighter; font-size: 20px;" >
                    ...
                    <br>
                    <br>Description
                    TetraPro Tropical Color Crisps offer a nutritionally balanced diet and beautiful color for tropical aquarium fish. With a high content of natural color enhancers and specially selected ingredients, this food ensures the full development of beautiful and rich coloration. These crisps float longer, so fish have longer to eat, the food gets eaten, and the water stays clear. An optimized protein-to-fat ratio helps fish metabolize food more efficiently, reducing waste in the aquarium.
                    </h1>
            </li>
        </a>
                ...
                <h3>FREE DELIVERY: Tuesday,Dec 12
                    ...
                    <option selected="selected">Choose one</option>
                      <?php
                        ...
                        $conn = new mysqli($hn,$un,$pw,$db);
                        if($conn -> connect_error) die($conn -> connect_error);
                        $query = "SELECT Available FROM Inventory WHERE ProductID = 2";
                        $result = $conn -> query($query);
                        if(!$result) die(mysqli_error($conn));
                        $numRows = $result -> num_rows;
                        $row = $result -> fetch_array(MYSQLI_ASSOC);
                    ...
                    <br>
                    <input name='productId' value="2" hidden>
