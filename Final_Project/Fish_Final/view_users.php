...
echo "<table class='gt_table' style='font-size:12px;margin:auto;border: 1px solid #000;margin-top: 300px;'>
    <thead>
        <tr>
            <th style='border: 1px solid #000; '>Firstname</th>
    ...
    <?php
        ...
        for ($j = 0; $j < $numRows; ++$j) {
            ...
            echo "<tr>";
            echo "<td style='border: 1px solid #000; '>" . $row['firstname'] . "</td>";
            echo "<td style='border: 1px solid #000; '>" . $row['lastname'] . "</td>";
            echo "<td style='border: 1px solid #000; '>" . $row['birthday'] . "</td>";
            echo "<td style='border: 1px solid #000; '>" . $row['email'] . "</td>";
            echo "<td style='border: 1px solid #000; '> <a href = 'update_users.php?username=$row[username]'>"  . $row['username'] . "</a></td>";
            
            echo "<td style='border: 1px solid #000; '> <form action='delete_users.php' method='post'>
