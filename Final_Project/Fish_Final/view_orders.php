...
echo "<table class='gt_table' style='font-size:12px;margin:auto;border: 1px solid #000; margin-top: 300px;'>
    ...
    <?php
        ...
        $query = 'SELECT OrderID,username,Name as ProductID,Quantity,method as delivery FROM `order` o inner join `delivery` d on o.delivery=d.delivery_id  inner join `inventory` i on o.ProductID=i.ProductID';
        ...
        for ($j = 0; $j < $numRows; ++$j) {
            ...
            echo "<tr>";
            echo "<td style='border: 1px solid #000; '>" . $row['OrderID'] . "</td>";
            echo "<td style='border: 1px solid #000; '>" . $row['username'] . "</td>";
            echo "<td style='border: 1px solid #000; '>" . $row['ProductID'] . "</td>";
            echo "<td style='border: 1px solid #000; '>" . $row['Quantity'] . "</td>";
            echo "<td style='border: 1px solid #000; '>" . $row['delivery'] . "</td>"; 
            echo "</tr>";
        }
        ?>
